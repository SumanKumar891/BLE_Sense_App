...
import com.merge.awadh.databinding.ActivityTest7Binding

class test7 : AppCompatActivity(), ScanAdapter.Delegate {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_test7)
        setupRecyclerView()
    ...
    private fun handleSelectedDevices() {
        ...
        if (selectedDeviceNames.isNotEmpty()) {
            val intent = Intent(this, test8::class.java).apply {
    ...
    private fun setupRecyclerView() {
        ...
        binding.scanResultsRecyclerView.apply {
            ...
            layoutManager = LinearLayoutManager(this@test7, RecyclerView.VERTICAL, false)
