...
class AdvertisingDataActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedDeviceName = intent.getStringExtra("DEVICE_NAME") //fetching device name
        val selectedDeviceAddress = intent.getStringExtra("DEVICE_ADDRESS") //fetching device address
        val deviceType = intent.getStringExtra("DEVICE_TYPE") //fetching device type
    ...
    //Parsing Speed Distance Sensor Data
    ...
    // Parsing Metal Detector Sensor Data
